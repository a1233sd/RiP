...
urlpatterns = [
    ...
    # Методы для работы с выговорами
    path('api/students/<int:student_id>/add_reprimand/', add_reprimand),  # POST
    path('api/students/<int:student_id>/reprimands/', get_reprimand_by_student_id),  # GET
